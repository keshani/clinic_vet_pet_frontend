...
export const ANIMAL_BY_USER_URL = '/animalDetailHandler/{ownerId}/animals';
export const ANIMAL_ADD_URL = '/animalDetailHandler/{ownerId}/animals';
export const ANIMAL_UPDATE_URL = '/animalDetailHandler/{ownerId}/animals/{id}';
export const ANIMAL_DELETE_URL = '/animalDetailHandler/animals/{id}';
export const ANIMAL_STATISTIC = '/animalStatisticHandler/animalsStatistic';
